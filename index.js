...
var svgs = [
  {
    svg: 'twitter svg',
    url:
      'https://res.cloudinary.com/ekwuno/image/upload/v1613611969/twitter.svg',
  },
  {
    svg: 'LinkedIn svg',
    url:
      'https://res.cloudinary.com/ekwuno/image/upload/v1613612188/linkedin.svg',
  },
...
class SocialTransformer {
  async element(element) {
    ...
    for (let svg of svgs) {
      element.append(`<a href="${svg.url}"><svg>${svg.svg}</svg></a>`, {
        html: true,
      })
    }
  }
